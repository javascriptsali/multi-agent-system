...
def run_agent_test(agent_name: str, task: str) -> str:
    ...
    """
    # Replace this logic with your actual single-agent execution call in graph.py
    # Example structure:
    if agent_name == "researcher":
        from src.agents import researcher_node
        # Assuming you have a helper or directly call node logic:
...
def run_full_graph(task: str) -> dict:
    ...
    """
    # Import your compiled app/graph instance here (e.g., app = workflow.compile())
